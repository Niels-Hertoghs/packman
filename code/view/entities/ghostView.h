...
public:
     ...
     * @param x De x coo van de start locatie van de ghost. (relatief tussen -1, en 1)
     * @param y De y coo van de start locatie van de ghost. (relatief tussen -1, en 1)
...
/**
* @class redGhostView
* @brief Concrete klasse voor de redGhost observer.
*/
...
public:
     ...
     * @param window Waar het op moet worden afgebeeld.
     * @param cam Camera klasse voor het omzetten naar pixel coordinaten.
     * @param x De x coo van de start locatie van de red ghost. (relatief tussen -1, en 1)
     * @param y De y coo van de start locatie van de red ghost. (relatief tussen -1, en 1)
     */
...
/**
* @class blueGhostView
* @brief Concrete klasse voor de blueGhost observer.
*/
...
public:
     ...
     * @param window Waar het op moet worden afgebeeld.
     * @param cam Camera klasse voor het omzetten naar pixel coordinaten.
     * @param x De x coo van de start locatie van de blue ghost. (relatief tussen -1, en 1)
     * @param y De y coo van de start locatie van de blue ghost. (relatief tussen -1, en 1)
     */
...
* @brief Concrete klasse voor de greenGhost observer.
*/
...
* @brief Concrete klasse voor de orangeGhost observer.
*/
...
public:
     ...
     * @param window Waar het op moet worden afgebeeld.
     * @param cam Camera klasse voor het omzetten naar pixel coordinaten.
     * @param x De x coo van de start locatie van de orange ghost. (relatief tussen -1, en 1)
     * @param y De y coo van de start locatie van de orange ghost. (relatief tussen -1, en 1)
     */
