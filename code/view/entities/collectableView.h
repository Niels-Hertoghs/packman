 ...
 * @brief Een abstracte klasse voor alle collectables representatie.
 */
...
public:
     ...
     * @param x De positie op de x-as van de collectable.
     * @param y De positie op de y-as van de collectable.
     */
...
public:
     ...
     * @param window Waar de collectable afgebeeld met worden.
     * @param x De positie op de x-as van de coin.
     * @param y De positie op de y-as van de coin.
     */
...
public:
    ...
    * @param window Waar de collectable afgebeeld met worden.
    * @param cam Camera klasse
    * @param x De positie op de x-as van de fruit.
    * @param y De positie op de y-as van de fruit.
    */
