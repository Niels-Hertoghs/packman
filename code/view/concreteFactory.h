...
public:
    ...
    std::shared_ptr<logic::Ghost> createGhost(ghostTypes typeGhost, double x, double y, float speed, int points) override;
    ...
    std::shared_ptr<logic::collectable> createCollectable(collectableTypes typeCollectable, double x, double y, int points) override;
};
} // view
