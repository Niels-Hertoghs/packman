...
wallView::wallView(Stopwatch& stopwatch, sf::RenderWindow& window, camera cam, std::shared_ptr<logic::wall> wallM) : entityView(stopwatch,window,cam),wallModel(std::move(wallM)) {
