...
redGhost::redGhost(const double x, const double y, const double speed, const int points)
...
void redGhost::givePacman(std::shared_ptr<Pacman> pacman) {
}

ghostTypes redGhost::getType() {
    return ghostTypes::RED;
}
